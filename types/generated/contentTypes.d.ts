...
export interface ApiArticalArtical extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categore: Schema.Attribute.Relation<'manyToOne', 'api::categore.categore'>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visiblity: Schema.Attribute.Enumeration<['public', 'member', 'vip']> &
      Schema.Attribute.DefaultTo<'public'>;
  };
}

export interface ApiCategoreCategore extends Struct.CollectionTypeSchema {
  collectionName: 'categores';
  info: {
    displayName: 'Categore';
    pluralName: 'categores';
    singularName: 'categore';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    articals: Schema.Attribute.Relation<'oneToMany', 'api::artical.artical'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    conteact_info: Schema.Attribute.String;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cases: Schema.Attribute.Component<'services.case-item', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    framework_points: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service.service'
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    icp_license: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    site_slogan: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    unionid: Schema.Attribute.String & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
